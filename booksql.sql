...
CREATE TABLE `customer`  (
  ...
  `cpreference` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `cpassword` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
-- Records of customer
-- ----------------------------
INSERT INTO `customer` VALUES ('1', '张三', '数学', 'F', '15811332255', '123456');
INSERT INTO `customer` VALUES ('2', '李四', '语文', 'M', '14455778899', '654321');
INSERT INTO `customer` VALUES ('3', '王五', '哲学', 'M', '12238969305', '1234567');
INSERT INTO `customer` VALUES ('4', '张全蛋', '工程', 'M', '14566773290', '7654321');
...
CREATE TABLE `member`  (
  ...
  `mdepartment` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `mgender` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- Records of member
-- ----------------------------
INSERT INTO `member` VALUES ('1', '杨旭航', '信息管理系', 'M');
INSERT INTO `member` VALUES ('2', '王越千', '信息管理系', 'M');
INSERT INTO `member` VALUES ('3', '岳铁骐', '信息管理系', 'M');
INSERT INTO `member` VALUES ('4', '高梓菡', '信息管理系', 'F');
...
CREATE TABLE `order_detail`  (
  ...
  CONSTRAINT `order_detail_ibfk_1` FOREIGN KEY (`obook`) REFERENCES `bookall` (`bISBN`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `order_detail_ibfk_2` FOREIGN KEY (`osale`) REFERENCES `sale` (`sID`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `sale`  (
  ...
  CONSTRAINT `sale_ibfk_1` FOREIGN KEY (`sseller`) REFERENCES `member` (`mID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `sale_ibfk_2` FOREIGN KEY (`scustomer`) REFERENCES `customer` (`cID`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `warehouse`  (
  ...
  CONSTRAINT `warehouse_ibfk_1` FOREIGN KEY (`wbook`) REFERENCES `bookall` (`bISBN`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `warehouse_ibfk_2` FOREIGN KEY (`wowner`) REFERENCES `member` (`mID`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of warehouse
-- ----------------------------
INSERT INTO `warehouse` VALUES ('1', '1007699860687', '1', '2018-10-01', 20);
INSERT INTO `warehouse` VALUES ('2', '9787030362173', '1', '2018-10-01', 150);
INSERT INTO `warehouse` VALUES ('3', '9787040406441', '1', '2018-10-01', 123);
INSERT INTO `warehouse` VALUES ('4', '9787040494792', '1', '2018-10-01', 55);
INSERT INTO `warehouse` VALUES ('5', '9787040406441', '2', '2018-10-01', 34);
INSERT INTO `warehouse` VALUES ('6', '9787040494792', '2', '2018-10-01', 455);
INSERT INTO `warehouse` VALUES ('7', '9787111376613', '2', '2018-10-01', 333);
INSERT INTO `warehouse` VALUES ('8', '9787121139253', '2', '2018-10-01', 88);
INSERT INTO `warehouse` VALUES ('9', '9787111376613', '3', '2018-10-01', 44);
INSERT INTO `warehouse` VALUES ('10', '9787121139253', '3', '2018-10-01', 11);
INSERT INTO `warehouse` VALUES ('11', '9787121139512', '3', '2018-10-01', 1111);
INSERT INTO `warehouse` VALUES ('12', '9787121155352', '3', '2018-10-01', 234);
INSERT INTO `warehouse` VALUES ('13', '9787121139512', '4', '2018-10-01', 8);
INSERT INTO `warehouse` VALUES ('14', '9787121155352', '4', '2018-10-01', 778);
INSERT INTO `warehouse` VALUES ('15', '9787121249884', '4', '2018-10-01', 67);
INSERT INTO `warehouse` VALUES ('16', '9787301053669', '4', '2018-10-01', 666);
