...
<body>
    <div height="400" width="1000" style="margin:50px">
    ...
    <script type="text/javascript">
        ...
        $colors= array('#F08080','#800080','#4169E1','#D3D3D3','#90EE90','#FFB6C1','	#FFA07A','	#20B2AA','#87CEFA','#B0C4DE','#87CEEB','#708090','#4682B4','#D2B48C','#008080','#D8BFD8','#FF6347','#40E0D0','#EE82EE','#F5DEB3','#FFFF00','#9ACD32');
        
        $all = array();
        
            for($i = 0; $i < sizeof($booksnum); $i++){
                $all[$i] = '['.$booksnum[$i].',"'.$colors[$i].'","'.$booksname[$i].'"]';
                }
        
        echo '<script type="text/javascript">charData = [';
