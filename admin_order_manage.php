  ...
  width: 200px;
    ...
    <ul class="upper_navigation">
        ...
        <li class="upper_navigation" style="float: right;"><a href="search_by_name.php">退出管理员界面</a></li>
         ...
         <form method="post" action="order_result.php" style="margin-left: 120px; float:left;padding:50px;">
		      <h2 style="text-align: left; padding-left:200px; color:white; font-size:40px;">根据订单号查询</h2>
		          <div style=" justify-content:left;padding-left:150px;font-size:24px; color:white;">

                        <input class="box" type="text" name="order_id">
                        	<br><br>
       ...
       <div style='width:1px;border:2px solid  #98FB98;float:left;height:600px;'></div></div>-->
        ...
        <form method="post" action="order_result.php" style="margin-left: 120px; float:left;padding:50px;">
            <h2 style="text-align: left;padding-left:200px; color:white; font-size:40px;">根据用户查询</h2>
            <div style=" justify-content:left;padding-left:150px;font-size:24px; color:white;">
